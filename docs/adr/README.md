# ADR 인덱스 — 2026 도서관 데이터 활용 공모전

| No | 결정 | 날짜 | 상태 |
|----|------|------|------|
| [0001](0001-api-data-model.md) | 백엔드 API 경계·데이터 모델 (2테이블, 확정 API 5개) | 2026-07-06 | accepted |
| [0002](0002-personalized-recommendation.md) | 개인화 추천 재도입 (키워드→정보나루→LLM, 세션 범위) | 2026-07-06 | accepted |
| [0003](0003-deployment-platform.md) | 배포 플랫폼 — Render 채택 | 2026-07-06 | accepted |
...
| [0008](0008-escape-layer-and-pdf-contract.md) | 이스케이프를 렌더 계층으로 단일화, PDF POST 전환, CI 도입 | 2026-07-21 | accepted |
